...
X_MIN = int(os.getenv('X_MIN',  -6780))
X_MAX = int(os.getenv('X_MAX',  2150))
Y_MIN = int(os.getenv('Y_MIN', 6550))
Y_MAX = int(os.getenv('Y_MAX',  15630))
FLOOR_ID = int(os.getenv('FLOOR_NUMBER', 4))
